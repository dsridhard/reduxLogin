...
const columns = [
  { field: "id", headerName: "Team ID", width: 190, type: "number" },
  { field: "firstName", headerName: "Rank", width: 190, type: "string" },
  { field: "lastName", headerName: "Team name", width: 190, type: "string" },
  {
    field: "age",
